...
class Rectangle():
	...
	def initial_points_of_rectangle(self):
		with self.lock_drawing:
			self.x_initial = 0		# 	(x_initial, y_initial)___________________
			self.y_initial = 0		#				|							|
	...
	def crop_image(self, image):
		""" Verifica se um retângulo válido foi desenhado e recorta o frame recebido por parâmetro dentro desse retâgulo.
